  ...
  return (
    <main className="min-h-screen bg-[#FAF8F2] flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-3xl rounded-[40px] bg-white shadow-xl p-8 md:p-12 text-center">
        ...
        <h2 className="mt-8 text-5xl font-light text-[#C9A96A]">Peculiar</h2>

        <p className="text-xl">&</p>

        <h2 className="text-5xl font-light text-[#C9A96A]">Chiedozie</h2>

        <p className="mt-10 text-gray-600 leading-8">
          We would be honoured to have you share in our joy as we begin this new
          chapter together.
        </p>
