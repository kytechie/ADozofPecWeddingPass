...
export default function Invitation() {
  return (
    <section className="relative bg-[#FAF8F2] py-40 px-8 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ delay: .4 }}
          className="mt-10 w-20 h-px bg-[#C9A96A] mx-auto"
        />
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          transition={{ delay: .5 }}
          className="mt-12 max-w-2xl mx-auto text-xl leading-[2.2rem] text-[#5E5650]"
        >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          transition={{ delay: .7 }}
          className="mt-10 max-w-xl mx-auto text-lg italic text-[#7C746D]"
        >
