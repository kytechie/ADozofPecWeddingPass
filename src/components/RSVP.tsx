          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4 mt-10 mb-14">
                ...
                <span className="text-[#C9A96A] text-lg">❦</span>
                <div className="w-12 h-px bg-[#C9A96A]" />
              </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-5 mt-6">
                      <button
                        ...
                        className={`rounded-3xl border px-6 py-5 text-left transition-all duration-300 ${
                          attending === true
          ...
          >
            ...
            >
              ...
              <p className="text-center text-lg leading-9 text-[#6B635C] max-w-2xl mx-auto">
                ...
                <br />
                Should you wish to bless us further, the account details are
                below.
              </p>
              ...
              <div className="flex justify-center mt-14">
                <div className="w-full max-w-lg rounded-3xl border border-[#E8D8B6] bg-[#FFFDFC] p-8 shadow-sm">
                  ...
                  <div className="mt-8 space-y-6">
                    <div>
                      <p className="text-sm text-[#9A938C]">Bank</p>
                    ...
                    <div>
                      <p className="text-sm text-[#9A938C]">Account Name</p>
                      <p className="mt-1 text-xl font-light text-[#2F2A27]">
                        Chiedozie Okoli
                      </p>
                    ...
                    <div>
                      <p className="text-sm text-[#9A938C]">Account Number</p>
              ...
              <p className="mt-12 text-center italic text-[#8A817A] leading-8 max-w-xl mx-auto">
                With grateful hearts, thank you for celebrating this special
                moment with us. May God bless you abundantly.
              </p>
            </motion.div>
          </motion.div>
        )}
